...
export const RetailAccountBalanceTimeDepositTurnoverForeignPreviewFlatSColumns = ['KEY_COLUMN', 'Icon', 'ValueDate', 'ProcessedDate', 'TransactionDescription', 'Reference', 'CurrencyCode', 'DebitAmount', 'CreditAmount', 'AmountTotal', 'Note', 'BeneficiaryAccount', 'CurrencyCodeNumber', 'TransactionType', 'TransactionBeneficiary', 'TransactionID'] as const;
...
export const RetailExchangeRateListFlat_NB_LColumns = ['KEY_COLUMN', 'CurrencyCodeNumeric', 'CountryCode', 'CurrencyCode', 'Parity', 'BuyingRate', 'CashBuyingRate', 'SellingRate', 'AvgRate', 'CashSellingRate'] as const;
...
export const RetailSMSNoticeUserAuthorizationColumns = ['KEY_COLUMN', 'FunctionID', 'SetLimit', 'LimitFrom', 'LimitTo', 'LimitCurrencyCodeNumeric', 'AuthorizationID', 'FunctionName'] as const;
...
export const RetailCreditCardMKSTurnoverPreviewMasterDetailLColumns = ['KEY_COLUMN', 'ProcessedDate', 'CardCustomName', 'InstallmentCount', 'OriginalCurrencyAmount', 'OriginalCurrencyCode', 'ValueDate', 'InstallmentCurrencyCode', 'CardNumber', 'Description', 'InstallmentOrderNumber', 'Reference', 'DebitAmount', 'TransactionBeneficiary', 'CreditAmount', 'TransactionType', 'BeneficiaryAccount'] as const;
...
export const RetailTransactionDetailsATMColumns = ['KEY_COLUMN', 'CreditAccount', 'DebtorDetails', 'Reference', 'DomesticAmount', 'CurrencyCodeNumeric_tx', 'CreditorAlias', 'Date', 'CardAlias', 'CardNumber', 'Amount_tx', 'Amount', 'CurrencyCode', 'CurrencyCode_tx', 'CurrencyCodeNumeric', 'c_Reference', 'CalculationDate'] as const;
